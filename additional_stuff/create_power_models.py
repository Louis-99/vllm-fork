...
def main():
    ...
    parser.add_argument('--model-dir', default=('/export2/obasit/ClusterLevelServing/vllm_logs/energy_profiler_logs/models_tree'), help='Directory to store trained models')
    ...
    CSV_PATH_TP4_D3 = "/export2/obasit/ClusterLevelServing/vllm_logs/energy_profiler_logs/profiler_logs_Nov19_TP4_decode_latency_largebatch/meta-llama/Llama-3.3-70B-Instruct/H100/1xTP4Prefill_1xTP4/decode_powers.csv"
