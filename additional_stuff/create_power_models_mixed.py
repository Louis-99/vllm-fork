#!/usr/bin/env python3
"""
Unified power model for prefill and decode with separate feature columns.
...
def main():
    ...
    UNIFIED_OUT = 'unified_power_model.joblib'
    ...
    # Save combined data
    df_combined.to_csv(os.path.join(MODEL_DIR, 'unified_power_data_cleaned.csv'), index=False)
    
    # Train unified model
    print('\n=== Training unified power model ===')
